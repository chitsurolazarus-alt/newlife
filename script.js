// Image configuration - Updated with youth6.jpg
const youthImages = ['youth1.jpg', 'youth2.jpg', 'youth3.jpg', 'youth4.jpg', 'youth5.jpg', 'youth6.jpg'];
...
const zimbabweCongregations = [
  ...
  { name: "Senangwe", pastor: "Overseer James Maravanyika & Mrs", phones: ["+263783765505", "+263777565537"] },
  { name: "Gutu", pastor: "Pastor & Mrs Chiphuva", phones: ["+263776614588"] },
  ...
  { name: "Zvishavane", pastor: "Pastor & Mrs Nhidza", phones: ["+263772488078", "+263773832935"] },
  { name: "Chisumbanje", pastor: "Pastor & Mrs Bella", phones: ["+263771871162", "+263778352233"] },
  { name: "Checheche", pastor: "Pastor & Mrs Nyambirai", phones: ["+263776088701", "+263784091571"] },
  { name: "Boroma", pastor: "Pastor & Mrs Chitambira", phones: ["+263788316571"] },
  { name: "Nemamwa Curios", pastor: "Pastor & Mrs Cheure", phones: ["+263774049779"] },
...
const southAfricaCongregations = [
  { name: "Polokwane", pastor: "Elder Hlangani & Mrs", phones: ["+27833633678", "+27717924781"] },
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Salvation button - asks user to call directly
  if (salvationBtn) {
